...
def main() -> None:
    ...
    parser.add_argument("--review-rounds", type=int, default=1, help="Run review/revision for N rounds.")
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path for persistent LLM response cache. Defaults to OUTPUT_ROOT/agent_workflow/llm_cache.json.",
    )
    ...
    if args.use_llm:
        ...
        if not args.no_llm_cache:
            cache_path = args.llm_cache_path or (workflow_dir / "llm_cache.json")
